...
const Footer = () => {
  return (
    <footer className="px-6 pt-8 md:px-16 lg:px-36 w-full text-gray-300 mt-15">
            ...
            <p className="pt-4 text-center text-sm pb-5">
                Copyright {new Date().getFullYear()} © <a href="https://youtube.com">MovieDash</a>. All Right Reserved.
            </p>
        </footer>
  )
}
